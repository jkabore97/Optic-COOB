...
- Photo-to-3D: `src/lib/frame-builder.ts` builds a textured GLB from the cut-out photo (contours from `src/lib/contour.ts`, pure and tested). Keep the builder deterministic and its output under 1 MB.
